...
public class ListOfGoals {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Here is your list of goals: \n" + getListOfGoals(), "List Of Goals", JOptionPane.INFORMATION_MESSAGE);
		//3. Call the appropriate method to get the number of goals you entered,
		//   and using a pop-up display the number of goals
		JOptionPane.showMessageDialog(null, "You entered " + getNumberOfGoals() + " goals", "List Of Goals", JOptionPane.INFORMATION_MESSAGE);
		...
		if (isManyGoals()) {
			JOptionPane.showMessageDialog(null, "Wow that's a lot of goals! Awesome!", "WOW", JOptionPane.INFORMATION_MESSAGE);
		}
